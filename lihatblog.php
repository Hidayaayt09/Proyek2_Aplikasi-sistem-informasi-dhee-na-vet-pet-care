  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a href="pelayanan.php" class="nav-link">Pelayanan</a></li>
          <li class="nav-item cta"><a href="index.php" class="nav-link">Logout</a></li>
...
<div class="paragraphs">
  <div class="row">
    <div class="span12 well">
      <img class="img-polaroid" src="images/<?=$hasil_data['gambar'];?>" style="width:250px; height: 200px; float:left; margin-right:10px;"/>
